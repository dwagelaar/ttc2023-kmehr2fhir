...
public interface SystemTypes
{
  ...
  public static ArrayList select_17(ArrayList _l)
  ...
  public static HashSet select_17(HashSet _l)
  { HashSet _results_17 = new HashSet();
    for (Object _i : _l)
  ...
  public static ArrayList select_18(ArrayList _l)
  ...
  public static HashSet select_18(HashSet _l)
  { HashSet _results_18 = new HashSet();
    for (Object _i : _l)
    { CDCONTENT cdx = (CDCONTENT) _i;
      if (((String) cdx.gets()).equals("CD-VACCINEINDICATION"))
      { _results_18.add(cdx); }
  ...
  public static boolean exists_12(Collection _l)
  ...
  public static boolean exists_14(Collection _l)
  ...
  { // implements: content->select( contx | contx /= null & contx.hcparty->size() > 0 )->collect( cntx | cntx.hcparty->any() )
    ...
    { ContentType cntx = (ContentType) _i;
     _results_9.add(((HcpartyType) Set.any(cntx.gethcparty())));
    }
    return _results_9;
  }

  public static ArrayList collect_21(Collection _l)
  { // implements: self.item->select( itemx | itemx.hcpartyContent() /= null )->collect( itemxx | itemxx.hcpartyContent() )
    ...
    { ItemType itemxx = (ItemType) _i;
     _results_21.add(itemxx.hcpartyContent());
    }
    return _results_21;
  }
